...
public class MongodbProducer implements Producer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MongodbProducer.class);
    ...
    public void publish(CloudEvent cloudEvent, SendCallback sendCallback) {
        try {
            ...
            logger.error("[MongodbProducer] publish happen exception.", ex);
    ...
    public void sendOneway(CloudEvent cloudEvent) {
        try {
            ...
            logger.error("[MongodbProducer] sendOneway happen exception.", ex);
        }
    }
